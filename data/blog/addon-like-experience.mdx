...
You can find the code for the decorator in [this repo](https://github.com/yannbf/braga.dev/blob/main/.storybook/preview.js), and here's a live embed of how this all behaves:

<iframe
  width="100%"
  height="600"
  src="https://main--62e6a1f33aafd7bc933a7071.chromatic.com/?path=/story/example-page--logged-out"
  title="Story example"
  frameBorder="0"
/>
